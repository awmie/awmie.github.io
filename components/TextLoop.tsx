...
/* Text flowing along a curve (GSAP-driven). Adapted from React Bits TextLoop:
   - "use client" + isomorphic layout effect (no SSR warning)
   - fill/stroke applied via `style` so they can use CSS vars and cross-fade
     with the light/dark theme
   - viewBox height tuned for the wave shape */
...
type Shape = "circle" | "infinity" | "arch" | "line" | "wave"
