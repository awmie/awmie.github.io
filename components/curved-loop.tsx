...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  const dirRef = useRef<"left" | "right">(direction) // Initialize with prop direction
  const velRef = useRef(0)

  // Ensure dirRef always reflects the initial direction prop
  useEffect(() => {
  ...
  const endDrag = () => {
    ...
    // Removed: dirRef.current = velRef.current > 0 ? "right" : "left";
    // The direction will now always be determined by the initial 'direction' prop.
  }
