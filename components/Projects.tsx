          ...
          <div>
            {projects.map((project) => (
              <a
                ...
                className="group block border-t border-line py-8 transition-colors hover:bg-ink-2 md:py-12"
              >
                <div className="grid gap-6 md:grid-cols-12">
                  ...
                  {/* serif title */}
                  <h3 className="font-pixel text-lg leading-snug text-bone transition-colors group-hover:text-accent md:col-span-4 md:text-3xl">
                    {project.name}
